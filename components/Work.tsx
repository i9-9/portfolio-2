      ...
      <div className=''>
        ...
        <div className='flex justify-between items-center text-verde text-sm'>
          ...
          <Marquee
            ...
            pauseOnHover={false}
            gradient={false}
            className='flex justify-center border border-t-verde border-b-verde py-1 mb-2'>
        ...
        href="/work/c7">
          ...
          <Marquee play={true} pauseOnHover={false} gradient={false} className='flex justify-center  border border-t-verde border-b-verde py-1 mb-2'>

          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`font-helveticaNowTextRegular ${errors.name ? 'border-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`font-helveticaNowTextRegular ${errors.email ? 'border-red-500' : ''}`}
                disabled={isSubmitting}
              />
              {errors.email && (
            ...
            <div className="flex gap-3 pt-4">
              <Button
                type="submit"
                disabled={isSubmitting}
                className="w-full font-helveticaNowTextRegular"
              >

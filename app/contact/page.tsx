...
const page = () => {
  return (
    <div className="h-auto bg-repeat pb-28 min-h-screen px-4 py-20 md:py-0">
      <Navbar />
      <h3 className="text-sm text-verde py-4">
      ...
      <div className="grid md:grid-cols-3 text-center gap-6 mx-1 ">
        <Link href='mailto:ivannevares9@gmail.com'>
          <div className=" text-verde h-fit py-1 hover:bg-[#5226AA] hover:text-[#ADE252] transition-all duration-700 border border-verde">

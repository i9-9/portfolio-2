...
/**
 * Mobile parallax travel — reduced to -30% for ultra-smooth performance
 * and buttery scroll on mobile devices. Much gentler effect that won't
 * cause jank even on budget phones.
 */
export const MOBILE_PARALLAX_TRAVEL = "-30%";

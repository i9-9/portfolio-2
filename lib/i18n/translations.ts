export const translations = {
  en: {
    ...
    about: {
      ...
      p2: ", where I focus on graphic design for various projects. Studying Graphic Design at Universidad de Buenos Aires (UBA).",
  ...
  es: {
    ...
    about: {
      ...
      p2: ", donde me dedico al diseño gráfico para distintos proyectos. Estudio Diseño Gráfico en la Universidad de Buenos Aires (UBA).",
      freelance: "Abierto a proyectos freelance.",
    },
    work: {
      title: "Proyectos",
